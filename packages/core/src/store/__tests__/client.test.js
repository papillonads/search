...
jest.mock('@papillonads/library/sort', () => ({
...
const libraryArrayMockObject = require('@papillonads/library/array') // eslint-disable-line
const librarySortMockObject = require('@papillonads/library/sort') // eslint-disable-line
